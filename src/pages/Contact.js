  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col rounded-lg border h-full w-full bg-gray-700 p-4">
        ...
        <h1 className="text-lg font-bold px-6 pb-2 flex my-2">brianmulinge45@gmail.com</h1>
        </div>
        <div className="">
        <label className="text-sm px-6 font-semibold pt-6">Address</label>
        <h1 className="text-lg font-bold px-6 pb-2 flex my-2">Irving, Texas</h1>
        </div>
        <a href="mailto:brianmulinge45@gmail.com">
          <button className="flex animate-pulse justify-center items-center p-4 h-full w-full rounded-3xl border-none bg-black font-semibold text-lg">
          Send me an email
          </button>
        </a>
      </div>
